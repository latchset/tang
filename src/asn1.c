...
ASN1_SEQUENCE(TANG_MSG_ADV_REP_BDY) = {
    ASN1_EXP_SET_OF(TANG_MSG_ADV_REP_BDY, sigs, TANG_KEY, 0),
    ASN1_EXP_SET_OF(TANG_MSG_ADV_REP_BDY, recs, TANG_KEY, 1),
...
ASN1_SEQUENCE(TANG_MSG_ADV_REQ) = {
    ASN1_EXP_SET_OF(TANG_MSG_ADV_REQ, keys, TANG_KEY, 0)
